<form class="form" method="post" action="<?= base_url('/loginpelanggan/index') ?>">
	...
	<div class="row">
		...
		<div class="col-6 my-2 mx-auto">
			<input style="background : #d11d1e; text-align : center;" class="btn btn-danger btn-block" type="submit" name="login" value="Login">
		</div>
	</div>
</form>
    ...
    <div class="row row-cols-3">
		<div class="col">
		    <a href="<?= base_url('registrasi') ?>">
	            <p style="color: #d11d1e; font-weight : bold;">Bukan member? <span>Sign Up</span></p>
            </a>
		</div>
		<!-- <div class="col">
