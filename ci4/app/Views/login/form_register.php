...
<form class="form" method="post" action="<?= base_url('/registrasi/insert') ?>">
	<div class="row">
		...
		<div class="col-lg-6 col-md-6 col-12">
			<div class="form-group">
				<label style="color : #000; font-weight : bold;">Nomer Telepon</label>
		...
		<div class="col-6 my-4 mx-auto">
			<input style="background : #d11d1e" class="btn btn-warning btn-block" type="submit" name="simpan" value="Register">
		</div>
	</div>
</form>
...
<a href="<?= base_url('loginpelanggan') ?>">
	<p style="color : #d11d1e; font-size: 18px font-weight : bold;">Sudah Punya akun? <span>Log In</span></p>
</a>