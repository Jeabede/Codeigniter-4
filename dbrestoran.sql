...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 01 Des 2020 pada 15.11
...
(1, 'Restoran Omelt', 'Restoran Omelt', 'Dsn. Mijen, Ds. Sidodadi, Kec. Taman Kab. Sidoarjo, Jawa Timur', 'omelt@gmail.com', '085604015383', 'Omelt Cake & Cookies', 'icon.png', 'logo.png', 'hero.jpg');
...
(19, 12, 'Boba Coklat', 'boba.jpg', 10000, '');
...
(35, 4, '2020-09-19', 200000, 200000, 0, 1),
(36, 5, '2020-10-26', 30000, 30000, 0, 1),
(37, 5, '2020-10-27', 30000, 0, 0, 0),
(38, 5, '2020-10-27', 30000, 0, 0, 0),
(39, 5, '2020-11-23', 52000, 0, 0, 0),
(40, 5, '2020-11-24', 45000, 45000, 0, 1),
(41, 17, '2020-11-24', 20000, 0, 0, 0),
(42, 5, '2020-11-24', 15000, 0, 0, 0);
...
(17, 'Suprat', 'Gedangan', '085615252616', 'suprat@gmail.com', '112233', 1);
...
--
ALTER TABLE `tblorderdetail`
  MODIFY `idorderdetail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=135;
